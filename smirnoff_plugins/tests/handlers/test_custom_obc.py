...
obc1_equiv_offxml = '''<SMIRNOFF version="0.3" aromaticity_model="OEAroModel_MDL">
    ...
    <CustomOBC blah="foo" version="0.3" alpha="0.8" beta="0.0" gamma="2.909125" solvent_dielectric="78.5" solute_dielectric="1" sa_model="ACE" surface_area_penalty="5.4*calories/mole/angstroms**2" solvent_radius="1.4*angstroms" kappa="0.0/angstrom">
...
<SMIRNOFF version="0.3" aromaticity_model="OEAroModel_MDL">
    ...
    <CustomOBC version="0.3" alpha="1.0" beta="0.8" gamma="4.85" solvent_dielectric="78.5" solute_dielectric="1" sa_model="ACE" surface_area_penalty="5.4*calories/mole/angstroms**2" solvent_radius="1.4*angstroms" kappa="0.0/angstrom">
      <Atom smirks="[*:1]" radius="0.15*nanometer" scale="0.8"/>
      <Atom smirks="[#1:1]" radius="0.12*nanometer" scale="0.85"/>
      <Atom smirks="[#1:1]~[#7]" radius="0.13*nanometer" scale="0.85"/>
      <Atom smirks="[#6:1]" radius="0.17*nanometer" scale="0.72"/>
...
class TestCustomOBC:
    def test_parse_xml(self):
        ff = ForceField(obc1_equiv_offxml, allow_cosmetic_attributes=True)
        assert 'blah' in ff.to_string()

    @requires_openeye_mol2
    @pytest.mark.parametrize(("gbsa_model"), ["OBC1", "OBC2"]) #"HCT",
    ...
    def test_freesolv_gbsa_energies(
        ...
        gbsa_offxmls ={'OBC1': obc1_equiv_offxml,
                       'OBC2': obc2_equiv_offxml}
        # Create OpenFF System with the current toolkit.
        ff = ForceField(
            "test_forcefields/test_forcefield.offxml", gbsa_offxmls[gbsa_model]
        )
        ...
        amber_gbsa_models = {'OBC1':openmm.app.OBC1,
